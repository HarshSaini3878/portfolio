...
<div className='flex flex-col md:flex-row h-[100vh] md:h-[90vh] w-[100vw]'>
  <div className='h-[50%] md:h-auto w-full md:w-[50%] bg-red-400 flex flex-col items-center justify-center gap-8 text-center md:text-left'>
...
<div className='w-[100%] md:w-[90%]'><Button className='text-2xl font-semibold  px-3 py-2 bg-gradient-to-r from-blue-500 to-white'>Contact Me</Button></div>
  </div>
  <div className='h-[50%] md:h-auto w-full md:w-[50%] bg-green-500 flex items-center justify-center'>
  <div className='w-[65%] h-[80%] bg-blue-500 rounded-full overflow-hidden'>
  <img 
